...
function standardTokenBehavior (
  supply, owner, recipient, anotherAccount, ZERO_ADDRESS
) {
  ...
  describe('transfer', function () {
    ...
    describe('when the recipient is the zero address', function () {
      ...
      it('reverts', async function () {
        await assertRevert(this.token.transfer(to, supply, { from: owner }))
      })
    })
  })
  ...
  describe('transfer from', function () {
    ...
    describe('when the recipient is not the zero address', function () {
      ...
      describe('when the spender has enough approved balance', function () {
        beforeEach(async function () {
          await this.token.approve(spender, supply, { from: owner })
        })
      ...
      describe('when the spender does not have enough approved balance', function () {
        beforeEach(async function () {
          await this.token.approve(spender, supply - 1, { from: owner })
        })
...
module.exports = standardTokenBehavior
