...
contract('Demopera', function (accounts) {
  ...
  beforeEach(async function () {
    ...
    let receipt = await
    web3.eth.getTransactionReceipt(this.token.transactionHash)
  })
  ...
  //       await assertRevert(this.token.recallOrganizationContribution(creator,
  ...
  //       assert.equal(pre[1] - recall, post[1])
  //     })
  ...
  //       const total = await this.token.getProject(creator, 0)
  //       assert.equal(total[1], conA + conB)
  //     })
  //     it('increments for individuals', async function () {
  //       await this.token.contributeToProject(creator, 0, conA)
  ...
  //       const total = await this.token.getTask(creator,0, 0)
  //       assert.equal(total[1], conA + conB)
  //     })
  //     it('increments for individuals', async function () {
  //       await this.token.contributeToTask(creator, 0, 0, conA)
